...
func printUsage() {
	fmt.Println("Usage: iterate_plugin [options]")
	fmt.Println("")
	fmt.Println("Options:")
	...
	fmt.Println("")
	fmt.Println("Example:")
	fmt.Println("  iterate_plugin -plugin iterative_ping -paramsJson '{\"host\":\"8.8.8.8\",\"count\":3}' -iterate -max 10 -delay 2")
}
